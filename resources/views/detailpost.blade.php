            ...
            <div class="main-content fl-right">
                <div class="section" id="list-blog-wp">
                    <div class="section-detail">
                        ...
                        <ul class="list-item">
                            <li class="clearfix">
                                <a href="{{ route('post') }}" title="" class="thumb fl-left">
                ...
                <div class="section-detail">
                    <p style="color:#e55039;margin-top:20px;">Click vào xem thêm để xem chi tiết bài viết </p>
                </div>
                <div id="seemore">
                    <p class="seemore">Xem thêm</p>
                    <div id="section_detail_product" class="section_detail_product">
                        <p id="description" class="description">{!! $post->description !!}</p>
